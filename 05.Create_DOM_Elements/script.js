...
let p2 = createElement('h3', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'emran' )
...
//Fourth Step (creation Div)
let p3 = createElement2('p', 'Lorem ipsum dolor sit amet, consectetur adip ut aliquip ex ea commodo consequat.', 'lead' )

let p4 = createElement2('span', 'Lorem ipsum dolor sit amet, consectetur adipisiullamco laboris nisi ut aliquip ex ea commodo consequat.', 'className' )

// let en = document.getElementById('cont')
// // eh.appendChild(p1)
// // eh.appendChild(p2)
// en.append(p3, p4)
// console.log(eh)
